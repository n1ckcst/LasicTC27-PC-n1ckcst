...
<div class="main-card">
    ...
    <div class="subtitle">Using $_POST method</div>
    ...
    <?php if(isset($_POST['submit']) && empty($errors) && !empty($firstname)): ?>
        <div class="success-data">
            <h3 style="font-size: 18px; margin-bottom: 10px;">Submitted Data (POST):</h3>
